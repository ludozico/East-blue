...
result = adfuller(train['target'][:1000], autolag='AIC')
...
decomposition = seasonal_decompose(train['target'][:1000].dropna(),
...
rolmean = train['target'][1000].rolling(window=3164).mean()
rolstd = train['target'][1000].rolling(window=3164).std()
